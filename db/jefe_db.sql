...
VALUES
    ...
    (121, 'Alberta' ,'Doswell' , 203050192, 'Store Manager', '1990-01-28' ,'2022-03-14', 35.00, 'adoswell0@prnewswire.com',4128543396,
     '7 Butternut Parkway','Pittsburgh','PA',09030, 121),
    (928, 'Augusto' ,'Belly' , 383619279, 'Busser', '1990-02-05' ,'2022-11-29', 11.00, 'abelly1@t-online.de',8505662100,
     '5140 Shasta Way','Pensacola','FL',29192, 121),
    (194, 'Winston' ,'Absolon' , 001824702, 'Cook', '1986-07-08' ,'2016-07-13', 15.00, 'wabsolon2@biblegateway.com',2133134747,
     '070 Fisk Court','Los Angeles','CA',82901, 435),
    (888, 'Lannie' ,'Reeder' , 299268192, 'Cashier', '1997-01-02' ,'2018-02-06', 18.00, 'lreeder3@last.fm',4127782443,
     '59 Comanche Terrace','Pittsburgh','PA',29270, 121),
    (783, 'Wyndham' ,'Fairlamb' , 101010101, 'Cook', '1990-07-19' ,'2015-09-01', 17.00, 'wfairlamb4@unicef.org',2022470586,
     '3 Coleman Alley','Washington','DC',22112, 121),
    (333, 'Guthrie' ,'Sketcher' , 002020122, 'Store Manager', '1961-09-28' ,'2019-06-15', 45.00, 'gsketcher5@marketwatch.com',2023431204,
     '3913 Dayton Pass','Washington','DC',22112, 333),
    (289, 'Kayla' ,'Geater' , 876238190, 'Support', '1995-12-22' ,'2011-02-22', 21.00, 'kgeater6@slashdot.org',5105468694,
     '26 3rd Trail','Sacramento','CA',98921, 333),
    (092, 'Roger' ,'Easey' , 282101727, 'Support', '1984-10-03' ,'2002-05-19', 21.00, 'reasey7@sciencedaily.com',8134537968,
     '2 Grayhawk Road','Tampa','FL',82912, 333),
    (124, 'Tybie' ,'Bestwall' , 191967732, 'Cook', '1964-03-02' ,'2021-01-27', 18.00, 'tbestwall8@soup.io',7856544878,
     '541 Dryden Court','Topeka','KS',29286, 333),
    (427, 'Ernie' ,'Odcroft' , 188288388, 'Cook', '1993-08-24' ,'2006-06-09', 19.00, 'eodcroft0@nymag.com',8509237837,
     '6 Waxwing Lane','Panama City','FL',92930, 333),
    (428, 'Jdavie' ,'Petrasch' , 828910468, 'Cashier', '1992-02-18' ,'2016-03-21', 15.00, 'jpetrasch1@aol.com',8166212709,
     '870 Banding Pass','Kansas City','MO',29291, 333),
    (429, 'Jacklin' ,'Blakemore' , 292716832, 'Cashier', '1963-05-05' ,'2007-01-18', 17.50, 'jblakemore2@nyu.edu',5619180387,
     '44713 Basil Street','West Palm Beach','FL',29281, 333),
    (430, 'Parker' ,'Buse' , 889129468, 'Support', '1984-05-03' ,'2019-09-11', 16.50, 'pbuse3@multiply.com',4806953156,
     '967 Fallview Pass','Scottsdale','AZ',00183, 333),
    ;
